...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "r", function()
		awful.spawn(os.getenv("HOME") .. "/.config/rofi/bin/general", false)
	...
	awful.key({ modkey }, "c", function()
		awful.spawn("rofi -show calc", false)
	end, { description = "Launch Rofi Calculator", group = "launcher" }),
